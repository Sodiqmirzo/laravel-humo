...
class OwnerPassportDTO
{
    public function __construct(
        ...
        public ?string $doc_validthrough = null,
        public ?string $person_code = null,
    ...
    public function toArray(): array
    {
        ...
        if (! empty($this->middle_name)) {
            $arr['sender_middle_name'] = $this->middle_name;
        }
        if (! empty($this->nationality)) {
            $arr['sender_nationality'] = $this->nationality;
        }
        if (! empty($this->doc_type)) {
            $arr['sender_doc_type'] = $this->doc_type;
        }
        if (! empty($this->doc_validthrough)) {
            $arr['sender_doc_validthrough'] = $this->doc_validthrough;
        }
        if (! empty($this->person_code)) {
            $arr['sender_person_code'] = $this->person_code;
        }
        if (! empty($this->birth_date)) {
            $arr['sender_birth_date'] = $this->birth_date;
        }
